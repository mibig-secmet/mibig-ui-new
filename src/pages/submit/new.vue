<template>
	<div id="submit" class="mx-auto p-4 max-w-5xl xl:max-w-6xl 2xl:max-w-7xl">
		...
		<div>
			The first step in submitting MIBiG information on an experimentally characterized
			biosynthetic gene cluster is to request an MIBiG accession number for it. This will be
			used to pre-fill information in the submission form. We will contact you once your
			accession number has been activated.
		</div>
		<div class="pt-6">
			Please specify the main compound(s) produced by the cluster.
			<form class="mb-0 space-y-6" action="#" method="POST" @submit="submitForm">
				<div
				...
				<div class="max-w-xs">
					<button
						class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-gray-700 bg-gray-200 active:bg-gray-400"
				...
				<div class="flex justify-between items-center max-w-6xl mx-auto">
					...
					<div class="flex justify-end items-center">
						<label for="start-nt" class="text-gray-700 font-semibold">Start nt:</label>
						<div class="mt-1">
							<input
								type="number"
								name="start-nt"
					...
					<div class="flex justify-end items-center">
						<label for="end-nt" class="text-gray-700 font-semibold">End nt:</label>
						<div class="mt-1">
							<input
								type="number"
								name="end-nt"
				...
				<div class="max-w-md mx-auto">
					<button
						class="bg-blue-mibig text-white rounded-lg shadow-lg py-2 w-full hover:bg-blue-mibig-light active:bg-blue-mibig-dark"
						type="submit"
					>
						Submit
					</button>
			...
			<div v-if="errors.length">
				...
				<ul class="list-disc">
					<li
						...
						:key="idx"
						:class="[
							error.result == 'error' ? 'text-red-error' : 'text-orange-warning',
						]"
					>
						{{ error.reason }}
					</li>
